export default {
  ...
  messageItem: {
    ...
    openHtmlPreview: 'Preview HTML',
    htmlPreviewSplit: 'Split',
    htmlPreviewCode: 'Code',
    htmlPreviewPreview: 'Preview',
    capture: 'Capture',
    captureToFile: 'Save as Image',
    captureToClipboard: 'Copy to Clipboard',
    save: 'Save',
