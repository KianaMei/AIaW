export default {
  ...
  providerSetting: {
    ...
    enabled: 'Enabled',
    enabledCaption: 'Enable or disable this provider',
    models: 'Available Models',
    modelsCaption: 'List of model IDs supported by this provider. You can manually enter or fetch from the provider.',
    fetchModels: 'Fetch models from provider',
    fetchModelsSuccess: 'Successfully fetched {count} models from provider',
    fetchModelsFallback: 'Failed to fetch models ({error}). Using {count} static models as fallback.',
    fetchModelsStatic: 'Loaded {count} static models for this provider',
    fetchModelsError: 'Failed to fetch models: {error}',
    validate: 'Validate Provider',
    validateSuccess: 'Provider validation successful',
    validateError: 'Provider validation failed: {error}',
    valid: 'Valid',
    invalid: 'Invalid',
    updateSuccess: 'Provider updated successfully',
    updateError: 'Failed to update provider: {error}',
