export default {
  ...
  exportDataDialog: {
    title: '導出使用者資料',
    removeUserMark: '移除使用者標記（遷移資料時勾選）',
    cancel: '取消',
    export: '導出',
    exportSuccess: '導出成功',
    exportFailed: '導出失敗'
  ...
  messageItem: {
    ...
    openHtmlPreview: '預覽 HTML',
    htmlPreviewSplit: '分屏',
    htmlPreviewCode: '程式碼',
    htmlPreviewPreview: '預覽',
    capture: '截圖',
    captureToFile: '儲存圖片',
    captureToClipboard: '複製到剪貼簿',
    save: '儲存',
    fullscreen: '全螢幕',
  ...
  payDialog: {
    pay: '支付',
    refreshAfterPay: '付款完成後，點擊「已完成付款」以刷新資料。若沒有跳轉支付，請手動複製支付鏈接，並在瀏覽器中開啟',
    cancel: '取消',
    paymentLink: '複製支付鏈接',
