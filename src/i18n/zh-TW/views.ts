export default {
  ...
  providerSetting: {
    ...
    logo: '圖示',
    type: '服務商類型',
    typeCaption: '該服務商使用的 API 協定類型',
    apiHost: 'API 位址',
    apiHostCaption: 'API 請求的基礎 URL（例如：https://api.example.com）',
    apiKey: 'API 金鑰',
    apiKeyCaption: '用於身分驗證的 API 金鑰',
    enabled: '啟用',
    enabledCaption: '啟用或停用此服務商',
    models: '可用模型',
    modelsCaption: '該服務商支援的模型 ID 清單。可以手動輸入或從服務商取得。',
    fetchModels: '從服務商取得模型',
    fetchModelsSuccess: '成功從服務商取得 {count} 個模型',
    fetchModelsFallback: '取得模型失敗（{error}）。使用 {count} 個靜態模型作為備用。',
    fetchModelsStatic: '已載入該服務商的 {count} 個靜態模型',
    fetchModelsError: '取得模型失敗：{error}',
    validate: '驗證服務商',
    validateSuccess: '服務商驗證成功',
    validateError: '服務商驗證失敗：{error}',
    valid: '有效',
    invalid: '無效',
    updateSuccess: '服務商更新成功',
    updateError: '更新服務商失敗：{error}',
    delete: '刪除服務商',
    deleteConfirmTitle: '刪除服務商',
    deleteConfirmMessage: '確定要刪除服務商"{name}"嗎？此操作無法復原。',
    deleteSuccess: '服務商刪除成功',
    deleteError: '刪除服務商失敗：{error}'
  },
  shortcutKeysView: {
    keyboardShortcuts: '鍵盤快捷鍵',
